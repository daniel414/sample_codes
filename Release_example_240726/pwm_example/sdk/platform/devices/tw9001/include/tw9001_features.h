...
/* @brief SPLL trimmed clock frequency(96MHz). */
#define FEATURE_SCG_SPLL_FREQ0 (96000000U)
/* @brief SPLL trimmed clock frequency(120MHz). */
#define FEATURE_SCG_SPLL_FREQ1 (120000000U)
...
typedef enum
{
    ...
    SIM_LPO_10K_CLK   = 27u, /**< LPO 10KHz clock                */
    SIM_LPO_125K_CLK  = 28u, /**< LPO 125KHz clock               */
...
#define TMP_SYSTEM_CLOCK_CONFIGS                                                              \
    { /*       SYS_CLK           SLOW_CLK */                                                  \
        {SCG_SYSTEM_CLOCK_DIV_BY_1, SCG_SYSTEM_CLOCK_DIV_BY_2},     /**< Dividers for SIRC */ \
            ...
            {SCG_SYSTEM_CLOCK_DIV_BY_4, SCG_SYSTEM_CLOCK_DIV_BY_4}, /**< Dividers for SPLL */ \
    }
