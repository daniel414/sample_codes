 ...
 */
static inline uint32_t
scg_get_spll_first_async_divider(const SCG_t *p_base)
{
    return (p_base->SPLLDIV & SCG_SPLLDIV_SPLLDIV1_MASK) >> SCG_SPLLDIV_SPLLDIV1_SHIFT;
}
 ...
 */
static inline uint32_t
scg_get_spll_second_async_divider(const SCG_t *p_base)
{
    return (p_base->SPLLDIV & SCG_SPLLDIV_SPLLDIV2_MASK) >> SCG_SPLLDIV_SPLLDIV2_SHIFT;
}
 ...
 */
static inline void
scg_set_spll_async_config(SCG_t *p_base, uint32_t div1, uint32_t div2)
{
    uint32_t reg_val =
        (uint32_t)(((div1 << SCG_SPLLDIV_SPLLDIV1_SHIFT) & SCG_SPLLDIV_SPLLDIV1_MASK) |
                   ((div2 << SCG_SPLLDIV_SPLLDIV2_SHIFT) & SCG_SPLLDIV_SPLLDIV2_MASK));
    p_base->SPLLDIV = reg_val;
}
