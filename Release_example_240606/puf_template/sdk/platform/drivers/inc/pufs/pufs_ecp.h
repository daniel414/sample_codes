 ...
 */
pufs_status_t pufs_ecp_gen_puk(pufs_ec_point_st *puk, pufs_key_type_t prktype, uint32_t prkslot);
 ...
 */
pufs_status_t pufs_ecp_ecccdh_2e(pufs_ec_point_st puk, pufs_ka_slot_t prkslot, uint8_t *ss);
